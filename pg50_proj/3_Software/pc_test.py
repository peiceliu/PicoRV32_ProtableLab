...
class MyApp_GUI(QWidget):
    def __init__(self):
        ...
        # self.DAC_uart = SerialProtocol(port = "COM5", baudrate = 9600)
        # self.ADC_uart = SerialProtocol(port = "COM4", baudrate = 9600)
        ...
        self.combo_wave_type.addItems(["正弦波", "方波", "三角波", "锯齿波"])
        ...
        self.combo_display_mode.addItems(["示波器1", "示波器2", "信号发生器", "频谱仪"])
        ...
        self.combo_voltage.addItems(["1V", "2V", "4V", "500mv","200mv","100mv"])
        ...
        # 触发线
        self.label_trigger_line = QLabel("请输入触发线：(49-449);248对应0V位置")
...
# ----------------------- 示波器配置 ------------------------ #
    ...
    def on_combo_change_deci_rate(self, index):
        ...
        if(selected_option_deci_rate == "1us"):
            ...
            deci_rate_value = format(1575, '08x')
        elif(selected_option_deci_rate == "1ms"):
            deci_rate_value = format(3150, '08x')
    ...
    def on_combo_change_voltage(self, index):
        ...
        elif(selected_option_voltage == "500mv"):
            voltage_value = format(0b10010, '08x')
        elif(selected_option_voltage == "200mv"):
            voltage_value = format(0b10101, '08x')
        elif(selected_option_voltage == "100mv"):
            voltage_value = format(0b11010, '08x')
    ...
    def on_click_trigger_line(self):
        ...
        self.label_trigger_line.setText(f"串口发送触发线配置: {trigger_line_value}取值范围:49-449;248对应0V位置")
